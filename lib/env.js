...
env.log_info_in_file =  process.env.LOG_INFO_IN_FILE || true;
env.log_error_in_file = process.env.LOG_ERROR_IN_FILE || true;
env.log_info_file_life = process.env.LOG_INFO_FILE_LIFE || 3;
env.log_error_file_life = process.env.LOG_ERROR_FILE_LIFE || 10;
env.log_file_path = process.env.LOG_FILE_PATH || 'log';
