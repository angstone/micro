...
function Env() {
  ...
  this.app_topic = process.env.APP_TOPIC || this.production ? 'as' : 'as_test';
  ...
  this.event_source_host = process.env.EVENT_SOURCE_HOST || 'localhost',
  this.event_source_port = process.env.EVENT_SOURCE_PORT || 1113,
  this.event_source_debug = process.env.EVENT_SOURCE_DEBUG || false,
  this.event_source_username = process.env.EVENT_SOURCE_USERNAME || 'admin',
  this.event_source_password = process.env.EVENT_SOURCE_PASSWORD || 'changeit',

  this.command_reducer_timeout = process.env.COMMAND_REDUCER_TIMEOUT || 3000;
  this.number_of_events_in_snapshot = process.env.NUMBER_OF_EVENTS_IN_SNAPSHOT || 1000;
  this.snapshot_datasheet_path = process.env.SNAPSHOT_DATASHEET_PATH || 'storage/';
  //mock: false,
