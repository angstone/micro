...
function Micro(_env=null) {
  this.env = require('./env.js');
  if(_env!=null) this.env = Object.assign({}, this.env, _env); // apply env merge
    ...
    if(procMod.load) {
      ...
      if( loadArray instanceof Array ) {
        loadArray.forEach( module_name => {
          ...
          console.log(this.modules[module_name]);
  ...
  // load the modules the general framework always need
  this.addProcedure({ load:[
    'logger',
    'error'
  ] });

  //console.log(this.procedures);
  //console.log(this.hemera_add_array);
  //console.log(this.modules);
  //console.log(this.modules.logger);
  //console.log(this.modules.env);
  //console.log(this.modules.error);
  //console.log(this.modules.error.load);
  ...
  this.close = (fn) => this.hemera.close(fn);
