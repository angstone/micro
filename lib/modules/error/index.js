...
function ErrorModule() {
  ...
  this.throwIfUnidentified = function(err, commonType=this.COMMON_TYPES.GENERIC_OPERATIONAL, description=this.NO_DESCRIPTION) {
    throw ( err.identified ? err : this.is(commonType, description) );
  }

  this.throwFatalIfUnidentified = function(err, commonType=this.COMMON_TYPES.GENERIC_OPERATIONAL, description=this.NO_DESCRIPTION) {
    throw ( err.identified ? err : this.fatal(commonType, description) );
  }
