...
rules.pre_validation = async function(data) {
...
rules.validation = async function(data) {
  /*this.models.user.create(data).findByLogin((err, taken)=>{
...
rules.respondWith = async function(data) {
